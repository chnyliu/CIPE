...
class ModelManager(object):
    ...
    def train(self, arch=None, actions=None, retrain_stage=None):
        ...
        try:
            ...
            model, metric, test_acc, stop_epoch = self.run_model(self.logger, model, optimizer, self.loss_fn,
            ...
            if metric < self.min_metric:
                ...
                torch.save(model, f'{self.main_args.logger_path}/{self.main_args.dataset}-{self.main_args.time}/model.pth')
    ...
    @staticmethod
    def run_model(logger, model, optimizer, loss_fn, data, epochs, early_stop=None, show_info=False):
        best_performance = 0
        ...
        return model, min_metric, best_performance, stop_epoch
